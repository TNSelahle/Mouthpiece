...
public class LoadingPageTest {
    @Rule
    public ActivityTestRule displaysViewLoading = new ActivityTestRule(LoadingPage.class, true, false);
    ...
    @Test
    public void OmegaTest() throws Exception {
    ...
    @Test
    public void mottoTest() throws Exception {
