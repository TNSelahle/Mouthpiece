...
//    session.setDebug(true);
        ...
        try{
            ...
            message.addRecipient(Message.RecipientType.TO ,new InternetAddress(json.getString("Email")));
            message.setSubject("Test the email");
            message.setText("This is the body of the email"+json.getString("Msg"));
...
//the old code is at the bottom here
/*
        try{
            String from = "cosomegatest@gmail.com";
